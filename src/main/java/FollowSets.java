...
public class FollowSets {
    ...
    public static Set<String> method() {
        ...
        return Set.of("INTEGER", "float", "boolean", "char", "string", "void", "}");
    }
    ...
    public static Set<String> body() {
        ...
        // FIRST(BODY)
        set.addAll(Set.of(";","INTEGER","float","boolean","char","string","void","id","return","print","if","while","do","for","switch","break","continue"));
        set.add("}");
        return set;
    }
